...
bool Engine::Init()
{
    ...
    player = new Doctor(new Properties("character", 100, 415, 120, 122));
...
void Engine::Update()
{
    ...
    player->Update(0);
    obstacles = new Obs(new Properties("Obstacles", 1100, 440, 74, 85));

    obstacles2 = new Obs(new Properties("Obstacles2", 1800, 400 , 48, 51));
